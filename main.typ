...
#import "@preview/scienceicons:0.0.6": github-icon, orcid-icon, linkedin-icon, website-icon
...
#h(.25cm)
#website-icon(baseline: 20%, height: 1em)
#link("https://swiftseal.github.io/")[swiftseal.github.io]
...
*University of St Andrews*, _PhD_ #h(1fr) 2020 - 2024
 - Thesis: "Applications of next-generation sequencing towards resistance gene identification" supervised by Prof. Ingo Hein and Prof. John Jones
 - EASTBIO Doctoral Training Programme

*University of Glasgow*, _BSc (Hons) in Molecular & Cellular Biology_ #h(1fr) 2016 - 2020
 - Dissertation: "Molecular regulation of sexual development in _Plasmodium berghei_" supervised by Prof. Andy Waters
 - First Class Honours

== Experience

*Postdoctoral Researcher* _University of Dundee_ #h(1fr) 2024 - Present
 - Analysis of plant responses to temperature stress through RNA-seq and Ribo-seq

*Postgraduate Researcher*, _James Hutton Institute_ #h(1fr) 2020 - 2024
 - Developed a suite of high-throughput workflows to assemble, extract, and analyse disease resistance genes from enrichment sequencing data
 - Developed `Resistify`, a software package for the identification of disease resistance genes in plants
 - Generated a high-quality reference genome for _Solanum verrucosum_ through next-generation sequencing
...
*Teaching Internship*, _Ghent University_ #h(1fr) Oct. 2021 - Dec. 2021
 ...
 - Developed a textbook for the IMaNema programme encompassing Nematology, Agronomy, and Molecular Biology
...
*Academic Skills Project*, _University of St Andrews_ #h(1fr) 2021 - 2023
...
*Lab demonstrator*, _University of St Andrews_ #h(1fr) 2021 - Feb 2023
